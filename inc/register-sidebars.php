 ...
 * 6. Course Page: Start
 * 7. Course Page: End
 * 8. Group Page: Start (added v1.1)
 * 9. Group Page: End (added v1.1)
 */
...
function ldxw_register_sidebars() {
	...
	register_sidebar(
		array(
			'id'            => 'ldxw_group_start',
			'name'          => __( 'LD Group: Content: Start', 'widget-areas-learndash' ),
			'description'   => __( 'At the very top of group pages, just below the page title & before any content.', 'widget-areas-learndash' ),
			'before_widget' => '<div id="%1$s" class="ldx-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'id'            => 'ldxw_group_end',
			'name'          => __( 'LD Group: Content: End', 'widget-areas-learndash' ),
			'description'   => __( 'At the very bottom of group pages, after all content.', 'widget-areas-learndash' ),
			'before_widget' => '<div id="%1$s" class="ldx-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
