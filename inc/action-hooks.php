 ...
 * @since 1.1
 */
function ldxw_learndash_group_before( $course_id, $user_id ) {

	if ( is_active_sidebar( 'ldxw_group_start' ) ) { ?>

		<div class="ldx-widget-area group-content-start">
			<?php dynamic_sidebar( 'ldxw_group_start' ); ?>
		</div>

	<?php }

}
add_action( 'learndash_group_before', 'ldxw_learndash_group_before', 10, 2 );
 ...
 * @since 1.1
 */
function ldxw_learndash_group_after( $course_id, $user_id ) {

	if ( is_active_sidebar( 'ldxw_group_end' ) ) { ?>

		<div class="ldx-widget-area group-content-end">
			<?php dynamic_sidebar( 'ldxw_group_end' ); ?>
		</div>

	<?php }

}
add_action( 'learndash_group_after', 'ldxw_learndash_group_after', 10, 2 );
