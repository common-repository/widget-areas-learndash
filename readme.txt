...
Adds multiple widget areas throughout the LearnDash interface. This plugin enables you to add unlimited blocks/widgets to several areas of Focus Mode and LearnDash course & group pages.
...
1. Navigate to "Appearance > Widgets" or open the Customizer to start adding blocks/widgets to your new widget areas
...
1. Click on the widget area in which you'd like to add content
1. Click the `+` icon or use the `/` key to choose a block or widget
1. Customize the content to your liking

-or-

1. Navigate to "Appearance > Widgets"
1. Locate the widget area you want to add content to
